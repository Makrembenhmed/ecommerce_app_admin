...
export default function Home() {
        ...
        <div className="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="text-center sm:text-left">
              ...
              <p className="mt-1.5 text-md text-gray-500 max-w-lg">view the statistics about your busniss also manage and add product 🎉</p>
            </div>

            <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
              <Link
                className="inline-flex items-center justify-center gap-1.5
                 rounded-lg border border-gray-200 px-5 py-3 text-gray-500 transition
                  hover:bg-gray-50 hover:text-gray-700 focus:outline-none focus:ring"
                href={'/products'}
              >
  ...
  return (
    <div className="flex flex-col min-h-screen justify-center items-center max-w-4xl m-auto" >
      ...
      <h1 className="text-4xl font-bold max-w-lg text-center "> Welcome to the Admin of the web Site </h1>
      <p className="font-medium my-4">An Account is needed to view this page.


      </p>
      <button
        className="inline-block rounded border border-blue-600 bg-blue-600 px-12 py-3 text-md font-medium text-white hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-indigo-500"
